...
class ComplexPlaneSlide(Slide):
    def construct(self):
        ...
        self.play(
            ...
            equation.animate.shift(LEFT * 4.5, DOWN),
        )
        plane = plane.target
...
class ValueToCoeff(Slide):
    ...
    def construct(self):
        ...
        values.scale(0.8).next_to(z, DOWN, 0.7).set_x(0)
        self.play(
        ...
        # BUG Plus signs on the second row are not transforming correctly.
        anim = []
